 ...
 * @Version v1.0
 */
public class BusinessBaseAdapter extends BaseAdapter {
	 ...
	 * @param buss
	 */
	public BusinessBaseAdapter(Context context, List<Business> buss) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(context).inflate(
					R.layout.list_business, null);
		}
		TextView name = (TextView) convertView.findViewById(R.id.list_buss_name);
		TextView type = (TextView) convertView.findViewById(R.id.list_buss_type);
		TextView addr = (TextView) convertView
				.findViewById(R.id.list_buss_address);
